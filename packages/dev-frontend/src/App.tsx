...
const UnsupportedMainnetFallback: React.FC = () => (
  ...
  >
    ...
    <Paragraph sx={{ mb: 3 }}>
      Please change your network to EthPOW, Rinkeby,.
    </Paragraph>
...
const App = () => {
  ...
  const unsupportedNetworkFallback = (chainId: number) => (
    ...
    >
      <Heading sx={{ mb: 3 }}>
        <Icon name="exclamation-triangle" /> Real Protocol is not yet deployed to{" "}
        {chainId === 1 ? "mainnet" : "this network"}.
      </Heading>
      Please switch to Mainnet version on Ethpow or testnet Rinkeby
    </Flex>
  );
