...
export const Yield: React.FC = () => {
  ...
  return (
    <Badge>
      <Text>REALP APR {aprPercentage.toString(2)}%</Text>
      <InfoIcon
        tooltip={
          <Card variant="tooltip" sx={{ width: ["220px", "518px"] }}>
            <Paragraph>
              An <Text sx={{ fontWeight: "bold" }}>estimate</Text> of the REALP return on the LUSD
              deposited to the Stability Pool over the next year, not including your ETHW gains from
              liquidations.
            </Paragraph>
            <Paragraph sx={{ fontSize: "12px", fontFamily: "monospace", mt: 2 }}>
              (($REALP_REWARDS * YEARLY_DISTRIBUTION%) / DEPOSITED_USDW) * 100 ={" "}
