  ...
  <ActionDescription>
    {params.depositCollateral && params.borrowLUSD ? (
      ...
      <>
        ...
        and receive <Amount>{params.withdrawCollateral.prettify()} ETHW</Amount>
      </>
    ) : params.depositCollateral && params.repayLUSD ? (
      <>
        You will deposit <Amount>{params.depositCollateral.prettify()} ETHW</Amount> and pay{" "}
        <Amount>
          {params.repayLUSD.prettify()} {COIN}
        </Amount>
      </>
      ...
      <>
        You will receive <Amount>{params.withdrawCollateral.prettify()} ETHW</Amount> and{" "}
        <Amount>
          {params.borrowLUSD.prettify()} {COIN}
        </Amount>
      </>
      ...
      <>
        You will deposit <Amount>{params.depositCollateral.prettify()} ETHW</Amount>
      </>
    ) : params.withdrawCollateral ? (
      <>
        You will receive <Amount>{params.withdrawCollateral.prettify()} ETHW</Amount>
      </>
    ) : params.borrowLUSD ? (
      <>
        You will receive{" "}
  ...
  if (depositCollateral.gt(accountBalance)) {
    return (
      <ErrorDescription>
        ...
        <Amount>{depositCollateral.sub(accountBalance).prettify()} ETHW</Amount>.
      </ErrorDescription>
    );
  }
