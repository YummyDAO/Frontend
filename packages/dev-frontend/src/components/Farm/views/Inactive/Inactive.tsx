    ...
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
        <InfoMessage title="You aren't farming LQTY.">
          <Paragraph>You can farm REALP by staking your Puffyswap ETHW/USDW LP tokens.</Paragraph>

          <Paragraph sx={{ mt: 2 }}>
            You can obtain LP tokens by adding liquidity to the{" "}
            <Link href={uniLink(addresses["lusdToken"])} target="_blank">
              ETHW/USDW pool on Puffyswap. <Icon name="external-link-alt" size="xs" />
            </Link>
          </Paragraph>
        </InfoMessage>
